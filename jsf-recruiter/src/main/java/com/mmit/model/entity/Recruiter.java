...
public class Recruiter implements Serializable {
	...
	@OneToMany(mappedBy = "modifyBy", cascade = REMOVE)
	private List<Candidate> candidate_modify;
	...
	public List<Candidate> getCandidate_modify() {
		return candidate_modify;
	}

	public void setCandidate_modify(List<Candidate> candidate_modify) {
		this.candidate_modify = candidate_modify;
	}
	...
	public List<InterviewRecord> getInterviewRecord_modify() {
		return interviewRecord_modify;
	}

	public void setInterviewRecord_modify(List<InterviewRecord> interviewRecord_modify) {
		this.interviewRecord_modify = interviewRecord_modify;
	}

	public List<InterviewRecord> getInterviewRecord_entry() {
		return interviewRecord_entry;
	}

	public void setInterviewRecord_entry(List<InterviewRecord> interviewRecord_entry) {
		this.interviewRecord_entry = interviewRecord_entry;
	}
